...
Enabled engines: yandex (the one engine that answers Korean everyday queries
from this network — Naver blogs, 지식iN, news sites), bing at low weight as a
fallback, yahoo and wikipedia for general search; the news category (bing
news, google news, duckduckgo news) answers fresh questions; google scholar,
...
timeout on every query. The measurements behind the choice are in the
settings file next to the engine list.
